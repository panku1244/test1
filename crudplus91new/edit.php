                  ...
                  <h2>Edit Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="edit1.php">
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="Date of birth" name="dob" value="<?php echo $a; ?>">
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <select class="form-control" name="city" id="city" value="<?php echo $d; ?>">
    <option value="Mumbai">Mumbai</option>
    <option value="Pune">Pune</option>
  </select>
                              <!-- <input class="form-control" placeholder="City" name="city" value="<?php echo $d; ?>"> -->
                            </div>
                            <div class="form-group">
                                          <select class="form-control" name="state" id="state" value="<?php echo $e; ?>">
    <option value="Maharshtra">Maharshtra</option>
    <option value="Goa">Goa</option>
  </select>
                              <!-- <input class="form-control" placeholder="State" name="state" value="<?php echo $e; ?>"> -->
                            </div> 
                           <!--  <div class="form-group">
                             <label>Comment</label>
